...
public class AluminiRegisterActivity extends Activity {

    private EditText etTPORegName, etTPORegPhone, etTPORegPassword, etTPORegEmail;
    private Button btnTPORegRegister;
    private static final String REGISTER_URL = "http://"+Config.ipAddress+"/PlacementApp/register_alumini.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.alumini_register);
        ...
        btnTPORegRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, REGISTER_URL,
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success) {
                                        ...
                                        Toast.makeText(AluminiRegisterActivity.this, "Registration successful", Toast.LENGTH_SHORT).show();
                                        // Redirect to login activity or dashboard
                                    } else {
                                        // Registration failed
                                        Toast.makeText(AluminiRegisterActivity.this, "Registration failed", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(AluminiRegisterActivity.this, "JSON Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                // Handle errors
                                Toast.makeText(AluminiRegisterActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }) {
                    @Override
                ...
                Volley.newRequestQueue(AluminiRegisterActivity.this).add(stringRequest);
            }
        });
    }
}
