...
public class CreateEvent extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (name.isEmpty() || date.isEmpty() || desc.isEmpty() || loc.isEmpty()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, EVENT_URL,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (success) {
                                    ...
                                    Toast.makeText(CreateEvent.this, "Create event successful", Toast.LENGTH_SHORT).show();
                                    // Redirect to login activity or dashboard
                                } else {
                                    // Registration failed
                                    Toast.makeText(CreateEvent.this, "Create event failed", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                                Toast.makeText(CreateEvent.this, "JSON Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            // Handle errors
                            Toast.makeText(CreateEvent.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }) {
                @Override
            ...
            Volley.newRequestQueue(CreateEvent.this).add(stringRequest);
        }
    }
